...
public partial class exam : System.Web.UI.Page
{
    ...
    // method for saving the result info in database and displaying on the current page
    public void saveinresult(string status, int score, int tquestion)
    {
        ...
        using (SqlConnection con = new SqlConnection(s))
        {
            ...
            try
            {
                ...
                lbl_questshowwarning.Text = "Your Result: " + status + "<br/>Score: " + score + "/" + tquestion;
                panel_questshow_warning.Visible = true;  // Assuming you have a panel to display the result
            }
            catch (Exception ex)
            {
                panel_questshow_warning.Visible = true;
